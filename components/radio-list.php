...
foreach ($options as $option) {
    ...
    if ($optionType === 'textbox') {
        ...
        $textInputHTML = '<input type="text"' . ($isChecked ? ' value="' . htmlentities($value) . '"' : '') . ' data-form-element-component="radio-list-option-textbox" placeholder="' . htmlentities((string)$option->getAttribute('placeholder')) . '">';
